        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('literacysession.reports')" :active="request()->routeIs('literacysession.reports')">
                        {{ __('Reports') }}
                    </x-nav-link>
                    <x-nav-link :href="route('literacysession.create')" :active="request()->routeIs('literacysession.create')">
                        {{ __('Literacy Session') }}
                    </x-nav-link>
